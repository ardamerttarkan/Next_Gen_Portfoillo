...
export const playlists: { id: string; name: string; image: string }[] = [
  {
    id: "p1",
    name: "Coding Flow",
    image: "https://picsum.photos/id/11/150/150",
  },
  {
    id: "p2",
    name: "Late Night Jazz",
    image: "https://picsum.photos/id/12/150/150",
  },
  {
    id: "p3",
    name: "Gym Motivation",
    image: "https://picsum.photos/id/13/150/150",
  },
  {
    id: "p4",
    name: "Discover Weekly",
    image: "https://picsum.photos/id/14/150/150",
  },
];
...
export const topTracks: Song[] = [
  ...
  },
  {
    ...
    title: "Instant Crush",
    artist: "Daft Punk",
    albumArt: "https://picsum.photos/id/21/50/50",
    duration: "5:37",
  },
  {
    id: "t3",
    ...
    albumArt: "https://picsum.photos/id/22/50/50",
    duration: "2:57",
  },
];
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Smart task management application that uses Gemini API to prioritize your daily workload.",
  ...
  },
  {
    ...
    description:
      "Web3 application to track portfolio performance across multiple chains.",
...
export const career: CareerItem[] = [
  {
    ...
    endDate: "",
    description:
      "Modern web uygulamaları geliştirme, mikro servis mimarisi tasarlama ve DevOps süreçlerini yönetme.",
  ...
  },
  {
    ...
    endDate: "2022-09",
    description:
      "Mobil uygulama geliştirme süreçlerine katılım, API entegrasyonları ve test otomasyonu.",
  ...
  },
  {
    ...
    startDate: "2021-01",
    endDate: "2023-05",
    description: "KOBİ'ler için web sitesi ve e-ticaret çözümleri geliştirme.",
